import calibrationsCalibratedGeometriesTheoremCanonicalLaneLean.ReviewerBridge
...
def CalibratedConstrainedTheoremClosed : Prop :=
  baselineCertificateLane = "calibrated_constrained" ∧
...
def TheoremLayerInternalized : Prop :=
  ...
  CalibratedConstrainedTheoremClosed
...
theorem calibrated_constrained_theorem_closed_checked :
    CalibratedConstrainedTheoremClosed := by
...
theorem theorem_layer_internalized_checked :
  ...
  exact And.intro classical_source_boundary_carried_checked calibrated_constrained_theorem_closed_checked
